    ...
    public class CubeiumBiomeFilterScreen extends Screen {
        ...
        private final List<CubeiumBiomeFilterCatalog.BiomeGroup> groups;
        ...
        public CubeiumBiomeFilterScreen(Screen parent, CubeiumSeedMapScreen.SeedMapSession session) {
            super(Text.translatable("cubeium.biome_filter.title"));
            this.parent = parent;
            this.session = session;
            this.groups = CubeiumBiomeFilterCatalog.getCategorizedBiomes(session.getBiomeGenerator());
        }
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            context.drawText(textRenderer,
                Text.translatable("cubeium.biome_filter.selected_count", session.getSelectedBiomeCount(), CubeiumBiomeFilterCatalog.flatten(groups).size()).getString(),
        ...
        private void renderBiomeCards(DrawContext context, int mouseX, int mouseY) {
            ...
            for (CubeiumBiomeFilterCatalog.BiomeGroup group : groups) {
        ...
        private void drawCategoryCard(DrawContext context, int mouseX, int mouseY, int cardX, int cardY, int cardWidth, CubeiumBiomeFilterCatalog.BiomeGroup group) {
            ...
            for (CubeiumBiomeFilterCatalog.BiomeEntry biome : group.entries()) {
