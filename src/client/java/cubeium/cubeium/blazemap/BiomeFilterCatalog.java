...
final class BiomeFilterCatalog {
    ...
    static List<BiomeGroup> getCategorizedBiomes(BiomeGenerator biomeGenerator) {
    ...
    static List<BiomeEntry> flatten(List<BiomeGroup> groups) {
    ...
    record BiomeEntry(int id, String name, int color) {
    }

    record BiomeGroup(String title, List<BiomeEntry> entries) {
    }
}